...
> fabric-shim@2.0.0-snapshot lint /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim
> eslint ./lib


> fabric-shim@2.0.0-snapshot test /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim
...
2019-10-10T11:57:29.925Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
      ✓ should start when passed init and invoke
2019-10-10T11:57:29.934Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
...
2019-10-10T11:57:29.971Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should call handler.chat() with the correct object and output a message
2019-10-10T11:57:29.980Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should load the opts certificate attributes as JSON strings with the correct properties
    parsePeerUrlFcn
2019-10-10T11:57:29.986Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument must be set to a legitimate value of <host>:<port>  
      ✓ should throw an error if peer.address not set
2019-10-10T11:57:29.992Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument can not be set to an "http(s)" url, use grpc(s) or omit the protocol  
...
2019-10-10T11:57:30.072Z info [c-api:fabric-shim/cli]                             
Command succeeded
  
      ✓ should handle rejected promise  correctly
2019-10-10T11:57:30.077Z info [c-api:fabric-shim/cli]                             undefined
Command failed
...
(node:24849) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 uncaughtException listeners added. Use emitter.setMaxListeners() to increase limit
      ✓ should throw an error if there is no transaction property
    #getMetadata
2019-10-10T11:57:30.732Z info [c-api:contracts-spi/bootstrap.js]                  Metadata file has been located  
      ✓ should handle when there are files available
2019-10-10T11:57:30.795Z info [c-api:contracts-spi/bootstrap.js]                  No metadata file supplied in contract, introspection will generate all the data  
...
schema $id ignored http://json-schema.org/draft-07/schema#
schema $id ignored http://json-schema.org/draft-07/schema#
2019-10-10T11:57:30.920Z info [c-api:contracts-spi/bootstrap.js]                  Metadata validated against schema correctly  
      ✓ validate and return the metadata (61ms)
...
schema $id ignored https://example.com/person.schema.json
schema $id ignored https://example.com/person.schema.json
2019-10-10T11:57:31.065Z info [c-api:contracts-spi/bootstrap.js]                  Metadata validated against schema correctly  
...
2019-10-10T11:57:31.075Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
2019-10-10T11:57:31.080Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a case where the metadata is incompatible with code
    #_compileSchemas
2019-10-10T11:57:31.084Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no complex objects being available
2019-10-10T11:57:31.088Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle complex objects being available
    #_resolveContractImplementations
2019-10-10T11:57:31.094Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.094Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
      ✓ should handle a single class being passed that is not valid
2019-10-10T11:57:31.106Z info [c-api:./lib/contract.js]                           Creating new Contract "beta" 
2019-10-10T11:57:31.107Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.107Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a two classes being passed as a contract
2019-10-10T11:57:31.111Z info [c-api:./lib/contract.js]                           Creating new Contract "beta" 
2019-10-10T11:57:31.112Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.112Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle the default tag being used
    #init
2019-10-10T11:57:31.116Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
<Buffer 44 65 66 61 75 6c 74 20 69 6e 69 74 69 61 74 6f 72 20 73 75 63 63 65 73 73 66 75 6c 2e>
      ✓ should handle a single class being passed as a contract
2019-10-10T11:57:31.121Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
    #invoke
2019-10-10T11:57:31.126Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
2019-10-10T11:57:31.131Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
2019-10-10T11:57:31.131Z info [c-api:./lib/contract.js]                           Creating new Contract "logging" 
2019-10-10T11:57:31.141Z info [c-api:logging]                                     info  
    ...
    #invokeFunctionality
2019-10-10T11:57:31.159Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
2019-10-10T11:57:31.161Z error [c-api:contracts-spi/chaincodefromcontract.js]     a logging prefix Error: Contract name is not known: name  
Error: Contract name is not known: name
    at ChaincodeFromContract.invokeFunctionality (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim/lib/contract-spi/chaincodefromcontract.js:62:656)
    at Context.it (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim/test/unit/contract-spi/chaincodefromcontract.js:617:22)
    at callFn (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:372:21)
    at Test.Runnable.run (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:364:7)
    at Runner.runTest (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:455:10)
    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:573:12
    at next (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:369:14)
    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:379:7
    at next (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:303:14)
    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:342:7
    at done (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:319:5)
    at callFn (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:395:7)
    at Hook.Runnable.run (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:364:7)
    at next (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:317:10)
    at Immediate._onImmediate (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:347:5)
    at runCallback (timers.js:705:18)
    at tryOnImmediate (timers.js:676:5)
    at processImmediate (timers.js:658:5)
      ✓ should handle missing function
2019-10-10T11:57:31.166Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
      ✓ should handle valid contract name, but missing function
2019-10-10T11:57:31.173Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
{ error
    at Object.fake.exceptionCreator (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/sinon/lib/sinon/default-behaviors.js:18:32)
    at Object.invoke (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/sinon/lib/sinon/behavior.js:151:35)
    at Object.functionStub (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/sinon/lib/sinon/stub.js:130:47)
    at Function.invoke (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/sinon/lib/sinon/spy.js:297:51)
    at Object.functionStub [as unknownTransaction] (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/sinon/lib/sinon/spy.js:152:22)
    at ChaincodeFromContract.invokeFunctionality (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim/lib/contract-spi/chaincodefromcontract.js:75:24)
    at Context.it (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim/test/unit/contract-spi/chaincodefromcontract.js:736:22)
    at callFn (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:372:21)
    at Test.Runnable.run (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:364:7)
    at Runner.runTest (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:455:10)
    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:573:12
...
2019-10-10T11:57:31.182Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
      ✓ should handle valid contract name, with valid function
2019-10-10T11:57:31.191Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
...
2019-10-10T11:57:31.208Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.208Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should be able to handle no annotations suppled
2019-10-10T11:57:31.215Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.215Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should be able to handle no annotations suppled
    #_processContractTransactions
2019-10-10T11:57:31.225Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.225Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no transaction annotations used, ignoring functions that match in name to ignore array
2019-10-10T11:57:31.237Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.237Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no transaction annotations used, ignoring functions that start with _
2019-10-10T11:57:31.253Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.253Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should not add submitTx to the system contract functions
2019-10-10T11:57:31.267Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.267Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle transaction annotations being used
2019-10-10T11:57:31.272Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2019-10-10T11:57:31.272Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
...
2019-10-10T11:57:31.379Z error [c-api:contracts-spi/datamarshall.js]              undefined Expected 1 parameters, but 0 have been supplied  
  ...
  SystemContract
    #constructor
2019-10-10T11:57:31.410Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should create correctly
    #GetMetadata
2019-10-10T11:57:31.411Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
...
2019-10-10T11:57:31.437Z error [c-api:lib/handler.js]                             Failed to find a message for transaction context id theChannelIDaTX  
    ...
    ChaincodeSupportClient
      ...
      chat
        ...
        stream.on.data
2019-10-10T11:57:31.525Z error [c-api:lib/handler.js]                             Chaincode is in "created" state, can only process messages of type "registered", but received "NOT REGISTERED"  
          ✓ should throw error when in state created and MSG_TYPE not REGISTERED
2019-10-10T11:57:31.573Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.573Z error [c-api:lib/handler.js]                             Chaincode is in "ready" state, can only process messages of type "established", but received "NOT REGISTERED"  
          ✓ should throw error when in state established and MSG_TYPE not READY
2019-10-10T11:57:31.623Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.623Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals REGISTERED
2019-10-10T11:57:31.656Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.656Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals READY
2019-10-10T11:57:31.686Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.686Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals RESPONSE
2019-10-10T11:57:31.715Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.715Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals ERROR
2019-10-10T11:57:31.750Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.750Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleInit when in state ready and MSG_TYPE equals INIT
2019-10-10T11:57:31.788Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.789Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleTransaction when in state ready and MSG_TYPE equals TRANSACTION
2019-10-10T11:57:31.819Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2019-10-10T11:57:31.819Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
2019-10-10T11:57:31.820Z error [c-api:lib/handler.js]                             Received unknown message from the peer. Exiting.  
          ✓ should end the process with value 1
        stream.on.end
          ✓ should cancel the stream
        stream.on.error
2019-10-10T11:57:31.866Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j {} 
          ✓ should end the stream
2019-10-10T11:57:31.887Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j "Error\n    at Context.it (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/libraries/fabric-shim/test/unit/handler.js:794:35)\n    at callFn (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:372:21)\n    at Test.Runnable.run (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runnable.js:364:7)\n    at Runner.runTest (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:455:10)\n    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:573:12\n    at next (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:369:14)\n    at /w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:379:7\n    at next (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:303:14)\n    at Immediate._onImmediate (/w/workspace/fabric-chaincode-node-merge-x86_64/gopath/src/github.com/hyperledger/fabric-chaincode-node/common/temp/node_modules/mocha/lib/runner.js:347:5)\n    at runCallback (timers.js:705:18)\n    at tryOnImmediate (timers.js:676:5)\n    at processImmediate (timers.js:658:5)" 
    ...
    handleMessage
      Error
2019-10-10T11:57:32.471Z error [c-api:lib/handler.js]                             %s Incorrect payload format. Sending ERROR message back to peer "[theChannelID-aTX]" 
        ✓ should handle an error decoding the payload
2019-10-10T11:57:32.473Z error [c-api:lib/handler.js]                             Failed to construct a chaincode stub instance from the INIT message: an error  
        ✓ should handle error creating a chaincode stub
2019-10-10T11:57:32.475Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2019-10-10T11:57:32.475Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning nothing
2019-10-10T11:57:32.477Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2019-10-10T11:57:32.477Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning nothing
2019-10-10T11:57:32.479Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2019-10-10T11:57:32.479Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning no status
2019-10-10T11:57:32.485Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2019-10-10T11:57:32.485Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning no status
      Complete
2019-10-10T11:57:32.488Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Init() succeeded. Sending COMPLETED message back to peer  
        ✓ should write a COMPLETE message when successful init
2019-10-10T11:57:32.490Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Invoke() succeeded. Sending COMPLETED message back to peer  
...
2019-10-10T11:57:32.586Z error [c-api:lib/iterators.js]                           unexpected error received getting next value: %s "some error" 
  ...
  Logger
    ✓ coverage
2019-10-10T11:57:32.609Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
